...
<?php $__env->startSection('custom_css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('themes/default/public/assets/dist/css/fontawesome-iconpicker.min.css')); ?>">
    
    <link href="<?php echo e(asset('/public/backend/assets/plugins/jquery-ui/jquery-ui.min.css')); ?>" rel="stylesheet">
...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="theme-option-container">
        <form action="<?php echo e(route('theme.default.save.option.form')); ?>" method="post" enctype="multipart/form-data"
            id="themeOptionForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="theme-option-tab-wrap">
                <div class="nav flex-column py-3 px-2 theme-option-sidebar" aria-orientation="vertical">
                    <?php if ($__env->exists('theme/default::backend.theme.option_sidebar')) echo $__env->make('theme/default::backend.theme.option_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
...
<?php $__env->startSection('custom_scripts'); ?>
    ...
    <script src="<?php echo e(asset('themes/default/public/assets/dist/js/fontawesome-iconpicker.min.js')); ?>"></script>
    ...
    <script>
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                function getOptionForm(id) {
                    ...
                    $.ajax({
                        type: "post",
                        url: '<?php echo e(route("theme.default.get.option.form")); ?>',
                        data: {
                            id: id
                        },
        ...
        function blog() {
            ...
            let image_source = "<?php echo e(asset('themes/default/public/assets/images/layout/variation-')); ?>" +
                variation_number + ".png";
            $('#blog_post_style_image').attr("src", image_source);

            $('.select').on('change', function() {
                variation_number = $("option:selected", this).data('image');
                image_source = "<?php echo e(asset('themes/default/public/assets/images/layout/variation-')); ?>" +
                    variation_number + ".png";
                $('#blog_post_style_image').attr("src", image_source);
            })
            ...
            let html = `
                <div class="accordion-item my-2">
                    <h2 class="accordion-header py-3" id="headingOne">
                        <button class="accordion-button  bg-transparent">
                            <?php echo e(translate('New Adsense')); ?>
                    ...
                    <div class="accordion-body row">
                        <div class="col-xl-12">
                            ...
                            <textarea name="adsense_code[]" class="theme-input-style style--seven" placeholder="<?php echo e(translate('Code')); ?>"></textarea>
                        </div>
                        <div class="col-xl-12 offset-xl-10">
                            <button type="button"
                                class="btn btn-danger accordion-delete sm mt-2"><?php echo e(translate('Delete')); ?></button>
                        </div>
                    </div>
                </div>
                `;
        ...
        function themeOptionCopyToClipboard(element) {
            ...
            let copied = "<?php echo e(translate('Copied')); ?>";
...
<?php echo $__env->make('core::base.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u768514428/domains/tayf.ae/public_html/themes/default/resources/views/backend/theme/options.blade.php ENDPATH**/ ?>