...
<?php $__env->startSection('main_content'); ?>
    <div class="app-items">
        <div class="align-items-center border-bottom2 d-flex flex-wrap gap-10 justify-content-between mb-4 pb-3">
            <h4><i class="icofont-plugin"></i> <?php echo e(translate('Plugins')); ?></h4>
            <?php if(!isTenant()): ?>
        ...
        <?php if(!isTenant()): ?>
            <div class="row">
                <?php $__currentLoopData = $plugins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plugin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($plugin['type'] == 'saas'): ?>
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 mb-30">
                            <div class="app-item">
                                <div class="app-icon">
                                    <?php if(File::exists(base_path('/plugins' . '/' . $plugin['location'] . '/banner.png'))): ?>
        ...
        <?php endif; ?>
        <!--End owner Plugin List-->
        <!--Tenant Plugin List-->
        <div class="row">
            <?php if(!isTenant()): ?>
                <div class="col-lg-12 mt-4 mb-2 pb-3">
                    <h4><i class="icofont-plugin"></i> <?php echo e(translate('Tenant Plugins')); ?></h4>
                </div>
            <?php endif; ?>
            <?php $__currentLoopData = $plugins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plugin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(
                    (!isTenant() && $plugin['type'] != 'saas') ||
                        (isTenant() && $plugin['is_activated'] == config('settings.general_status.active'))): ?>
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 mb-30">
                        <div class="app-item">
                            <div class="app-icon">
                                <?php if(File::exists(base_path('/plugins' . '/' . $plugin['location'] . '/banner.png'))): ?>
...
<?php echo $__env->make('core::base.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u768514428/domains/tayf.ae/public_html/Core/Views/base/plugins/index.blade.php ENDPATH**/ ?>