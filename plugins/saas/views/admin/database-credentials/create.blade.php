...
@section('title')
    {{ translate('Add Database Credential') }}
@endsection
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card">
                <div class="card-header bg-white border-bottom2 pb-0">
                    <div class="post-head d-flex justify-content-between align-items-center mb-3">
                        <div class="d-flex align-items-center">
                            <div class="content">
                                <h4>{{ translate('Add Database Credential') }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div>
                        <form action="{{ route('plugin.saas.database-credentials.store') }}" method="POST">
                            @csrf
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="db_name" class="theme-input-style"
                                        value="{{ old('db_name') }}" placeholder="{{ translate('Enter database name') }}" required>
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="db_user" class="theme-input-style"
                                        value="{{ old('db_user') }}" placeholder="{{ translate('Enter database user') }}" required>
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="db_password" class="theme-input-style"
                                        value="{{ old('db_password') }}" placeholder="{{ translate('Enter database password') }}" required>
