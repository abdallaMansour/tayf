                ...
                <div class="modal-content">
                    <form action="{{ route('plugin.saas.tenant.database.create') }}" method="post"
                        ...
                        <div class="modal-body">
                            ...
                            {{-- Get first database credential --}}
                            @php
                                $databaseCredential = \Plugin\Saas\Models\DatabaseCredential::where('is_active', false)->first();
                            @endphp
                            ...
                            <table class="table-bordered mt-3">
                                <tr>
                                    ...
                                    <td>
                                        <p id="" database>{{ $databaseCredential->db_name }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p id="" database_username>{{ $databaseCredential->db_user }}</p>
                                        {{-- {{ env('DB_USERNAME') }} --}}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <p id="database_password">{{ $databaseCredential->db_password }}</p>
                                        {{-- {{ env('DB_PASSWORD') }} --}}
                                    </td>
                                </tr>
                                <tr>
                            ...
                            @else
                                <p class="text-danger">{{ translate('No database credential found') }}</p>
                            @endif
                        </div>
        ...
        (function($) {
            ...
            $('.change-status').on('click', function(e) {
                ...
                if (isdbcreated == 0) {
                    ...
                    $('#database_username').html(database);
