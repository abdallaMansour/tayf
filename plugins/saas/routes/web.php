...
use Plugin\Saas\Http\Controllers\Admin\DatabaseCredentialController;
...
Route::group(['prefix' => getAdminPrefix(), 'middleware' => ['handle.expired.account']], function () {
    ...
    Route::group(['middleware' => $applied_middleware], function () {
         ...
         */
        Route::get('database-credentials', [DatabaseCredentialController::class, 'index'])->name('plugin.saas.database-credentials.index')->middleware('can:Manage SAAS Settings');
        Route::get('database-credentials/create', [DatabaseCredentialController::class, 'create'])->name('plugin.saas.database-credentials.create')->middleware('can:Manage SAAS Settings');
        Route::post('database-credentials', [DatabaseCredentialController::class, 'store'])->name('plugin.saas.database-credentials.store');
        Route::get('database-credentials/{databaseCredential}', [DatabaseCredentialController::class, 'show'])->name('plugin.saas.database-credentials.show')->middleware('can:Manage SAAS Settings');
        Route::get('database-credentials/{databaseCredential}/edit', [DatabaseCredentialController::class, 'edit'])->name('plugin.saas.database-credentials.edit')->middleware('can:Manage SAAS Settings');
        Route::put('database-credentials/{databaseCredential}', [DatabaseCredentialController::class, 'update'])->name('plugin.saas.database-credentials.update');
        Route::delete('database-credentials/{databaseCredential}', [DatabaseCredentialController::class, 'destroy'])->name('plugin.saas.database-credentials.destroy');
    });
